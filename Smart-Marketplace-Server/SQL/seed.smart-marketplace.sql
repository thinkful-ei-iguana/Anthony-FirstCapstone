...
INSERT INTO users
    (Name, Email, Location, Username, Password, Date_Created)
VALUES
    ('Anthony Bostic', 'anthonytb97@gmail.com', 'Seattle, WA', 'Anthony', 'abcd1234', now()),
    ('test user1', 'test1@gmail.com', 'Seattle, WA', 'test1', 'abcd1234', now()),
    ('test user2', 'test2@gmail.com', 'Seattle, WA', 'test2', 'abcd1234', now()),
    ('test user3', 'test3@gmail.com', 'Seattle, WA', 'test3', 'abcd1234', now());

INSERT INTO listings
    (Title, Owner, Location, Date_Created, Condition, Price, Description, Image)
VALUES
